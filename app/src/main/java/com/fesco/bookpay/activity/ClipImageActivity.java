...
import com.fesco.bookpay.view.cliperimage.ClipViewLayout;
...
public class ClipImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void generateUriAndReturn() {
        ...
        File pic = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM+ "/Camera_Clip");
        if (!pic.exists()) {
            pic.mkdirs();
        }
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.CHINA).format(new Date());
        String fileName = "clip_image_" + timeStamp + "";
        File tmpFile = new File(pic, fileName + ".jpg");


        Uri mSaveUri = Uri.fromFile(tmpFile);
        ...
        if (mSaveUri != null) {
            ...
            intent.putExtra("path",tmpFile.getAbsolutePath());
