...
import com.fesco.bookpay.fragment.OvertimeApplicationFragment;
import com.fesco.bookpay.fragment.OvertimeRecordFragment;
 ...
 */
public class OvertimeActivity extends BaseActivity implements BackHandledInterface{
    ...
    private void initViewPager() {
        ...
        fragments.add(OvertimeApplicationFragment.getInstance(loginEntity));
        fragments.add(OvertimeRecordFragment.getInstance(loginEntity));
   ...
   //    mTabLayout.setupWithViewPager(mViewPager);
    ...
    BasePageBackFragment basePageBackFragment;
    @Override
    public void setSelectedFragment(BasePageBackFragment basePageBackFragment) {
          this.basePageBackFragment=basePageBackFragment;
    }

    @Override
    public void onBackPressed() {
        if(basePageBackFragment == null || !basePageBackFragment.onBackPressed()){
