...
import com.fesco.bookpay.impl.Callback;
...
public class KSelectImagesActivity extends FragmentActivity implements Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   ActivityManager.getInstance().addActivity(this);
        ...
        mDefaultCount = intent.getIntExtra(Constants.EXTRA_SELECT_COUNT, 5);
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (resultList != null && resultList.size() > 0) {
                    ...
                    intent.putStringArrayListExtra(Constants.EXTRA_RESULT, resultList);
                    setResult(RESULT_OK, intent);
               //         KUtils.actionStart(KSelectImagesActivity.this, ConsumptionActivity.class, bundle);
