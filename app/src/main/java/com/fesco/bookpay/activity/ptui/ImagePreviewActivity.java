...
import com.fesco.bookpay.event.RefreshImageSelect;
import com.fesco.bookpay.util.ptutils.Constants;
import com.fesco.bookpay.util.ptutils.DisPlayUtils;
      ...
      //  ActivityManager.getInstance().addActivity(this);
        ...
        if (!isPreviewAll) {
            ...
            if (tempImagePath.size() == 0) {
                ...
                mPreviewCommit.setText(getString(R.string.finish) + "(" + tempImagePath.size() + "/" + 5 + ")");
            }
    ...
    private void checkMarkImage() {
        ...
        if (isPreviewAll) {
            ...
            if (tempImagePath.containsKey(imagePath)) {
                ...
                // 如果选择的图片大于5张则无法继续选择图片
                if (tempImagePath.size() >= 5) {
    ...
    void onClicks(View view) {
        switch (view.getId()) {
            ...
            case R.id.preview_commit:
                ...
                intent.putStringArrayListExtra(Constants.EXTRA_RESULT, getResultList());
