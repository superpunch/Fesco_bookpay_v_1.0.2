...
public class CustomIosDialog extends Dialog {
	...
	public CustomIosDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CustomIosDialog create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final CustomIosDialog dialog = new CustomIosDialog(context,
					R.style.mystyle);
			View layout = inflater.inflate(R.layout.dialog_iphone, null);
...
//									confirmDialogListener cdl= (confirmDialogListener) context;
//									cdl.confirmDialog();
