...
public class FileDownloadManager {
     ...
     * @return download id
     */
    public long startDownload(String uri, String title, String description,String version_code) {
        ...
        req.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, version_code+"update.apk");
        //第二种
