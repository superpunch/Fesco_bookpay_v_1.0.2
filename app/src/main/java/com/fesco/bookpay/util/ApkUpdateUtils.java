...
import com.fesco.bookpay.weight.FileDownloadManager;
...
public class ApkUpdateUtils {
    ...
    public static void download(Context context, String url, String title, String version_code) {
...
//                    }
                ...
                start(context, url, title,version_code);
    ...
    private static void start(Context context, String url, String title,String version_code) {
        long id = FileDownloadManager.getInstance(context).startDownload(url,
                title, "下载完成后点击打开",version_code);
